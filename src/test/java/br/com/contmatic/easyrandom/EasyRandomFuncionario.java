...
public final class EasyRandomFuncionario {
	...
	public static EasyRandom validadorEasyRandomFuncionario(TipoDadoParaTesteFuncionario tipoDadoParaTeste) {
		...
		case SALARIO_PRECIA_SER_VALOR_MAIOR:
			...
			break;
		case TELEFONE_NULL:
			dadosFuncionarioValidos(parameters, faker, "telefone");
			telefone(parameters, null);
			break;
	...
	private static void dadosFuncionarioValidos(EasyRandomParameters parameters, Faker faker, String nomeCampoUsado) {
		...
		if (!nomeCampoUsado.equalsIgnoreCase("telefone"))
			telefone(parameters, EasyRandomTelefone.validadorEasyRandomTelefone(TipoDadoParaTesteTelefone.VALIDO)
	...
	private static void telefone(EasyRandomParameters parameters, Telefone telefoneFuncionario) {
		Randomizer<Telefone> telefone = new Randomizer<Telefone>() {
			@Override
			public Telefone getRandomValue() {
				return telefoneFuncionario;
			}
		};
		parameters.randomize(FieldPredicates.named("telefone"), telefone);
	}

...
public class FuncionarioTest {
    ...
    public void deve_ser_do_rh_para_contratar() {
        ...
        funcionarios.get(0).contratarFuncionario("james", "james@gmail.com", Cargo.REPOSITOR, new BigDecimal(2500.00), data, funcionarios.get(0), loja, TipoContrato.PJ,
            FixtureFactoryEndereco.enderecoValido());
        assertFalse(loja.getFuncionario().stream().anyMatch(func -> func.getEmail().equalsIgnoreCase("james") && func.getEmail().equalsIgnoreCase("james@gmail.com")));
    }
    ...
    public void deve_ser_do_rh_para_contratar_expection() {
        ...
        funcionarios.get(1).contratarFuncionario("james", "james@gmail.com", Cargo.REPOSITOR, new BigDecimal(2500.00), data, funcionarios.get(1), loja, TipoContrato.PJ,
    ...
    public void deve_ser_do_rh_para_contratar_e_nao_deve_ter_loja_null_exception() {
        ...
        funcionarios.get(0).contratarFuncionario("a", "a@gmail.com", null, new BigDecimal(2500.00), data, funcionarios.get(0), loja, TipoContrato.PJ,
    ...
    public void deve_ser_do_rh_para_contratar_e_nao_pode_ter_salario_null_exception() {
        ...
        funcionarios.get(0).contratarFuncionario("a", "a@gmail.com", Cargo.REPOSITOR, null, data, funcionarios.get(0), loja, TipoContrato.PJ,
    ...
    public void deve_ser_do_rh_para_contratar_e_nao_pode_ter_salario_negativo_exception() {
        ...
        funcionarios.get(0).contratarFuncionario("james", "james@gmail.com", Cargo.REPOSITOR, new BigDecimal(-10.00), data, funcionarios.get(0), loja, TipoContrato.PJ,
    ...
    public void deve_ser_do_rh_para_contratar_e_nao_pode_ter_tipoContrato_null_exception() {
        ...
        funcionarios.get(0).contratarFuncionario("a", "a@gmail.com", Cargo.REPOSITOR, new BigDecimal(500.00), data, funcionarios.get(0), loja, null,
            FixtureFactoryEndereco.enderecoValido());
    }
    ...
    public void nao_deve_existir_na_loja_funcionario_para_contratar() {
        ...
        funcionarios.get(0).contratarFuncionario("lucas", "lucas@gmail.com", Cargo.REPOSITOR, new BigDecimal(2500.00), data, funcionarios.get(0), loja, TipoContrato.PJ,
    ...
    public void deve_ser_do_rh_para_demitir() {
        ...
        assertFalse(loja.getFuncionario().stream().anyMatch(func -> func.getEmail().equalsIgnoreCase("lucas") && func.getEmail().equalsIgnoreCase("lucas@gmail.com")));
    }

...
public class EmpresaTest {
    ...
    public static void cadastrar_empresa() {
        ...
        empresa.getEnderecos().add(from(Endereco.class).gimme(VALID));
    ...
    public void deve_add_produto_na_loja() {
        ...
        assertTrue(empresa.getProdutos().size() > 0);
    }
    ...
    public void deve_add_funcionario_na_empresa() {
        ...
        assertTrue(empresa.getFuncionarios().size() > 0);
    }
    ...
    public void deve_add_cliente_na_empresa() {
        ...
        assertTrue(empresa.getClientes().size() > 0);
    }

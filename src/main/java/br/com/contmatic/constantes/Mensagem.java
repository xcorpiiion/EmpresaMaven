...
public final class Mensagem {
    ...
    public static final String CNPJ_EMPRESA_INVALIDO = "Cnpj de empresa possui algum caractere invalido";

    public static final String TELEFONE_EMPRESA_VAZIO = "Telefone de empresa não pode ser vazio";

    public static final String ENDERECO_EMPRESA_VAZIO = "Endereco de empresa não pode ser vazio";
    ...
    public static final String CPF_CLIENTE_INVALIDO = "Cpf de cliente possui algum caractere invalido";

    public static final String TELEFONE_CLIENTE_VAZIO = "Telefone de cliente não pode ser vazio";

    public static final String ENDERECO_CLIENTE_VAZIO = "Endereco de cliente não pode ser vazio";

    public static final String DATA_NASCIMENTO_CLIENTE_VAZIO = "Data de nascimento de cliente não pode ser vazio";

    public static final String DINHEIRO_CARTEIRA_CLIENTE_TAMANHO = "Data de nascimento de cliente não pode ser vazio";
    ...
    public static final String CPF_FUNCIONARIO_VAZIO = "Cpf de funcionario não pode ser vazio";

    public static final String TELEFONE_FUNCIONARIO_VAZIO = "Telefone de funcionario não pode ser vazio";

    public static final String ENDERECO_FUNCIONARIO_VAZIO = "Endereco de funcionario não pode ser vazio";

    public static final String DATA_NASCIMENTO_FUNCIONARIO_VAZIO = "Data de nascimento de funcionario não pode ser vazio";

    public static final String CARGO_FUNCIONARIO_VAZIO = "Cargo de funcionario não pode ser vazio";
    ...
    public static final String CEP_ENDERECO_VAZIO = "Cep de endereço não pode ser vazio";

    public static final String CEP_ENDERECO_CARACTERE_INVALIDO = "Cep de endereço deve apenas possuir números";
    ...
    public static final String TELEFONE_VAZIO = "Telefone não pode ser vazio";

    public static final String TELEFONE_CARACTERE_INVALIDO = "Telefone deve apenas possuir números e deve possuir entre 9 e 8 números";
